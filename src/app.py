...
activities = {
    ...
    "Soccer Club": {
        "description": "Develop footwork, strategy, and match play in a friendly team setting",
        "schedule": "Tuesdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["ava@mergington.edu", "mia@mergington.edu"]
    },
    "Drama Club": {
        "description": "Act, perform, and explore theatre techniques through rehearsals and scenes",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["isabella@mergington.edu", "charlotte@mergington.edu"]
    },
    "Art Workshop": {
        "description": "Experiment with drawing, painting, and creative visual expression",
